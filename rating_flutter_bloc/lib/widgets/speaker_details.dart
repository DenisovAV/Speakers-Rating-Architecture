...
import 'package:rating_flutter_bloc/utils/utils.dart';
            ...
            child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                      ...
                      child: Center(child: Text(speaker.name, style: TextStyle(fontSize: 30.0)))),
                  Padding(
                      padding: EdgeInsets.all(12.0),
                      child: Center(child: Text(speaker.topic, style: TextStyle(fontSize: 20.0)))),
                  RatingBar(
